package com.wjk.group.connection;
...
public class TmConnection implements Connection {
    ...
    public TmConnection(Connection connection) {
    ...
    public void commit() throws SQLException {
        ...
        ThreadPool.POOL.execute (new Runnable () {
            ...
            public void run() {
                ...
                System.out.println("我commit开始等待了");
                System.out.println("trmId是:" + transactionPojo.getTrmId() + " task是:" + transactionPojo.getTask ());
                transactionPojo.getTask ().waitTask ();
                System.out.println("trmId是:" + transactionPojo.getTrmId() + " task是:" + transactionPojo.getTask ());
                System.out.println("我commit等待结束了");
    ...
    public void rollback() throws SQLException {
        ...
        new Thread (new Runnable () {
            ...
            public void run() {
                try {
                    System.out.println("我rollback开始等待了");
                    transactionPojo.getTask ().waitTask ();
                    System.out.println("我rollback等待完成了");
                    connection.rollback ();
                    connection.close ();
